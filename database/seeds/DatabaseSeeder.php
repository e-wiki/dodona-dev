...
class ChecksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Check::create(['id' => 'POL002', 'name' => 'Outbound NRTRDE Record Processing', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL003', 'name' => 'Outbound NRTRDE File Processing', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL004', 'name' => 'DIRRDAR Validated Files', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL005', 'name' => 'DIRRDAR Missing Dates/Corrupt Files', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL006', 'name' => 'DIRRDAR File Errors', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL007', 'name' => 'Inbound NRTRDE Summary', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL008', 'name' => 'Inbound NRTRDE Record Processing', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL009', 'name' => 'Inbound NRTRDE File Processing', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL010', 'name' => 'Inbound NRTRDE Zone Rating', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL011', 'name' => 'FDR Record Processing Error', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL012', 'name' => 'FDR File Processing Error', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL013', 'name' => 'HUR Error Processing', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL014', 'name' => 'RHA Error Processing', 'check_category_id' => 'P', 'check_module_id' => 2]);
        Check::create(['id' => 'POL015', 'name' => 'NRTRDE Rating Error', 'check_category_id' => 'P', 'check_module_id' => 2]);
...
class CheckResultsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        CheckResult::create(['id' => 'PNL004A01', 'name' => 'Log warnings found', 'check_id' => 'PNL004', 'alert_id' => 'A']);
        CheckResult::create(['id' => 'PNL004G01', 'name' => 'No log warnings found', 'check_id' => 'PNL004', 'alert_id' => 'G']);
        CheckResult::create(['id' => 'PNL004R01', 'name' => 'Log warnings exceed RED threshold', 'check_id' => 'PNL004', 'alert_id' => 'R']);
        CheckResult::create(['id' => 'PNL005A01', 'name' => 'Log errors found', 'check_id' => 'PNL005', 'alert_id' => 'A']);
        CheckResult::create(['id' => 'PNL005G01', 'name' => 'No log errors found', 'check_id' => 'PNL005', 'alert_id' => 'G']);
        CheckResult::create(['id' => 'PNL005R01', 'name' => 'Log errors exceed RED threshold', 'check_id' => 'PNL005', 'alert_id' => 'R']);
        CheckResult::create(['id' => 'PNL006A01', 'name' => 'NRTRDE files found', 'check_id' => 'PNL006', 'alert_id' => 'A']);
        CheckResult::create(['id' => 'PNL006G01', 'name' => 'No NRTRDE files found', 'check_id' => 'PNL006', 'alert_id' => 'G']);
